...
class Data:
    ...
    def view_seatmatrix(self):
        ...
        with use_scope('ROOT'):
            put_image(header_img, width='100%', height='150px', position=0)
    ...
    def view_cutoff_marks(self):
        ...
        if mymachine.allotment_done== False:
            ...
            with use_scope("main", clear=True):
                ...
                put_table([
                    {"Branch": "Computer Science Engineering", "Cutoff marks": self.cutoff_marks["Computer"]},
            ...
            if mymachine.allotment_done== True:
                ...
                with open("datasheet.csv",'r') as f:
                    ...
                    with use_scope("main", clear=True):
                        ...
                        input('Nucat Marks', name='marks', type=NUMBER, required=True, help_text="Enter score out of 200.",validate=check_cet),
                        file_upload(label="Nucat Scorecard", accept=".pdf", name='cet_score_file',max_size='10M', placeholder="choose a file")
                        ],)
    ...
    def student_sign_up(self):
        ...
        signup_img = open('images/banner-1.jpg', 'rb').read()
        with use_scope("main", clear=True):
            put_image(signup_img,width='150%',height='400px')
            data = input_group("Student Sign Up",[input('Enter your Name', type=TEXT, name='name',required=True), input('Enter your Surname', name='surname', type=TEXT, required=True)])
